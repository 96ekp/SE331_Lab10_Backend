...
// return new PageImpl<Event>(eventList.subList(firstIndex, firstIndex +
// pageSize),
...
// return
// eventRepository.findByTitleContainingOrDescriptionContainingOrOrganizer_NameContaining(title,
// title, title, page);
// }
